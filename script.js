...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (typeof window.ethereum !== "undefined") {
        ...
        const web3 = new Web3(window.ethereum); await window.ethereum.request({ method: "eth_requestAccounts" });
 const accounts = await web3.eth.getAccounts();
 const account = accounts[0];
 console.log("Connected account:", account);
const contractAddress = "0x7b96aF9Bd211cBf6BA5b0dd53aa61Dc5806b6AcE"; const contractABI = [[
	{
		"inputs": [],
		"name": "donate",
		"outputs": [],
